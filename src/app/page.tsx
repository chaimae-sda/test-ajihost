          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <label className="relative cursor-pointer flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-300 rounded-xl bg-gray-50 hover:bg-gray-100 hover:border-gray-400 transition-all overflow-hidden group">
                {backgroundImage ? (
                  <>
                    <img src={backgroundImage} alt="Uploaded form preview" className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:opacity-30 transition-opacity" />
                    <UploadCloud className="w-8 h-8 text-gray-900 mb-2 relative z-10" />
                    <span className="text-sm font-bold text-gray-900 relative z-10">Image sélectionnée</span>
                    <span className="text-xs font-semibold text-gray-800 mt-1 bg-white/70 px-2 py-1 rounded backdrop-blur-sm relative z-10">Cliquez pour modifier</span>
                  </>
                ) : (
                  <>
